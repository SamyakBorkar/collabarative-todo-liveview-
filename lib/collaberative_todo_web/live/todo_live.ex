      ...
      <div class="w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="p-6 space-y-4">
          <%= for item <- @items do %>
            <div
              ...
              class="group flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md hover:border-indigo-300 transition-all duration-200 cursor-pointer"
            >
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-100">
          <form phx-submit="add" class="flex gap-2">
            ...
            <button
              type="submit"
              class="bg-indigo-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-indigo-700 transition-colors shadow-lg"
            >
              Add
            </button>
          </form>
